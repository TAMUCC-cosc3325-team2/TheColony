...
namespace TheColony
{
    public class ScenarionMenu : Screen
    {
        ...
        private void setScenario(int index)
        {
            ...
            {
                case 0:
                    ScenarioBg = ScreenManager.Game.Content.Load<Texture2D>(@"Background\NuclearExplosion");
                    break;
                case 1:
                    ScenarioBg = ScreenManager.Game.Content.Load<Texture2D>(@"Background\chemicalwarfare");
                    break;
                case 2:
                    ScenarioBg = ScreenManager.Game.Content.Load<Texture2D>(@"Background\biblicalwarfare");
                    break;
                case 3:
                    ScenarioBg = ScreenManager.Game.Content.Load<Texture2D>(@"Background\naturaldisaster");
                    break;
            }
        }
    }
